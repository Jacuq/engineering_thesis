...
W systemach budowanych na bazie REST API komunikacja pomiêdzy aplikacj¹ frontendow¹ i~backendow¹ odbywa siê w sposób przedstawiony na rysunku \ref{fig:restArchitecture}. Aplikacja frontendowa wysy³a ¿¹dania protoko³em HTTP pod odpowiedni adres URL, a w odpowiedzi otrzymuje dane zserializowane do formatu XML b¹dŸ JSON (format JSON jest obecnie bardziej preferowany). Te, po odpowiednim przetworzeniu, s¹ prezentowane przegl¹darkom internetowym dzia³aj¹cym na urz¹dzeniach klientów. 
\begin{figure}[H]
 \centering
 ...
 % DONE: u¿yto rysunku dodanego przez promotora, poprawiono literówkê
\includegraphics[width=\textwidth]{rys04/restapi}
...
Korzystaj¹c z mo¿liwoœci oferowanych przez framework Angular zdecydowano siê rozbiæ aplikacjê na mniejsze elementy -- charakterystyczne dla tej biblioteki komponenty oraz serwisy. 
