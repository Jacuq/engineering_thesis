...
\begin{abstract}
Ninejsza praca in¿ynierska to dokumnetcja projektowa aplikacji webowej opartej na REST API s³u¿¹cej do wspierania muzycznego samokszta³cenia. Aplikacja ma pomagaæ muzykom w opanowaniu teorii muzyki przy pomocy wirtualnych instrumentów oraz interaktywnych æwiczeñ. Praca skupia siê przede wszystkim na stronie technicznej projektu. Pierwsze rozdzia³y s³u¿¹ omówieniu zastosowanych technologii, architektury i podjêtych decyzji projektowych. Nastêpnie omówiona jest implementacja systemu. Na koñcu przedstawione s¹ zrealizowane cele oraz perspektywy na rozwój aplikacji. 
