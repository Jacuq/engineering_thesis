...
Korzystaj¹c z takich za³o¿eñ wszystkie akordy, skale i interwa³y opisano za pomoc¹ odleg³oœci od poprzedniego dŸwiêku. Pierwszy dŸwiêk to zawsze nuta g³ówna, drugi dŸwiêk opisany jest odleg³oœci¹ od nuty g³ównej, trzeci dŸwiêk odleg³oœci¹ od drugiego dŸwiêku itd. Realizacja tych wzorców widoczna jest na listingu \ref{key:chordsPatterns}.
...
Zawartoœæ przyk³adowych katalogów z serisem i komponentem mo¿na zobaczyæ na rysunku \ref{fig:scfig:schemat_FE2}.
\begin{figure}[H]
	 \centering
...
\begin{figure}[htb]
  \centering
	\begin{tabular}{@{}ll@{}}
	a) & b) \\
  \vtop{\vskip-2ex\hbox{\fbox{\includegraphics[width=0.5\linewidth]{rys05/ear_training1}}}} & 
	\vtop{\vskip-2ex\hbox{\fbox{\includegraphics[width=0.5\linewidth]{rys05/ear_training2}}}}
	\end{tabular}
...
\begin{figure}[htb]
  \centering
	\begin{tabular}{@{}ll@{}}
	a) & b) \\
  \vtop{\vskip-2ex\hbox{\fbox{\includegraphics[width=0.5\linewidth]{rys05/quiz1}}}} & 
	\vtop{\vskip-2ex\hbox{\fbox{\includegraphics[width=0.5\linewidth]{rys05/quiz2}}}}
	\end{tabular}
